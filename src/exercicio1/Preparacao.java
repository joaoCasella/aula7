...
public class Preparacao {
	...
	public void associaPokemons(Treinador treinador, Treinador treinador2){
		...
		treinador2.criaVetorPokemons();
		treinador2.preenchePokemons(pokemons2);
	}
	...
	public void associaAtaques(Treinador treinador, Treinador treinador2){
		...
		String ataques2[][] = new String[4][4];
		double dano2[][] = new double[4][4];
		...
		ataques2[0][0] = "Triturar";
		dano2[0][0] = 23.0;
		ataques2[0][1] = "Cavar";
		dano2[0][1] = 25.0;
		ataques2[0][2] = "Investida";
		dano2[0][2] = 22.0;
		ataques2[0][3] = "Batida";
		dano2[0][3] = 20.0;
		
		ataques2[1][0] = "Poder Oculto";
		dano2[1][0] = 22.0;
		ataques2[1][1] = "Lancamento de Rocha";
		dano2[1][1] = 28.0;
		ataques2[1][2] = "Investida";
		dano2[1][2] = 22.0;
		ataques2[1][3] = "Mega-soco";
		dano2[1][3] = 23.0;
		
		ataques2[2][0] = "Supersonico";
		dano2[2][0] = 22.0;
		ataques2[2][1] = "Voar";
		dano2[2][1] = 21.0;
		ataques2[2][2] = "Redemoinho de Vento";
		dano2[2][2] = 23.0;
		ataques2[2][3] = "Mordida";
		dano2[2][3] = 24.0;
		
		ataques2[3][0] = "Agilidade";
		dano2[3][0] = 10.0;
		ataques2[3][1] = "Giro de fogo";
		dano2[3][1] = 20.0;
		ataques2[3][2] = "Lanca-chamas";
		dano2[3][2] = 22.0;
		ataques2[3][3] = "Trovao";
		dano2[3][3] = 15.0;
		
		treinador2.ataquesPokemons(ataques2, dano2);
	}	
}
